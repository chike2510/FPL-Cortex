  ...
  try {
    ...
    const payload = {
      elements: data.elements.map((p) => ({
        ...
        cost_change_event: p.cost_change_event,     // price change this GW
        cost_change_start: p.cost_change_start,     // price change since start
        expected_goals: p.expected_goals,           // xG season total
        expected_assists: p.expected_assists,       // xA season total
